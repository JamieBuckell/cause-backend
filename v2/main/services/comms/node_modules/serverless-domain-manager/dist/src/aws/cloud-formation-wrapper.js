...
class CloudFormationWrapper {
    ...
    getApiId(domain, stackName) {
        return __awaiter(this, void 0, void 0, function* () {
            const logicalResourceId = globals_1.default.CFResourceIds[domain.apiType];
            let response;
            try {
    ...
    getImportValues(names) {
        return __awaiter(this, void 0, void 0, function* () {
            const exports = yield (0, utils_1.getAWSPagedResults)(this.cloudFormation, "listExports", "Exports", "NextToken", "NextToken", {});
    ...
    getStack(logicalResourceId, stackName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield (0, utils_1.throttledCall)(this.cloudFormation, "describeStackResource", {
    ...
    getNestedStack(logicalResourceId, stackName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const stacks = yield (0, utils_1.getAWSPagedResults)(this.cloudFormation, "describeStacks", "Stacks", "NextToken", "NextToken", {});
            ...
            for (const name of filteredStackNames) {
                try {
                    ...
                    globals_1.default.logWarning(err);
                }
            }
            return response;
        });
