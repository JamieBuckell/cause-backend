...
class ServerlessCustomDomain {
    constructor(serverless, options, v3Utils) {
        ...
        if (v3Utils) {
            globals_1.default.log = v3Utils.log;
            globals_1.default.progress = v3Utils.progress;
        }
        this.commands = {
            create_domain: {
                lifecycleEvents: [
    ...
    createDomain(domain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const creationProgress = globals_1.default.log && globals_1.default.progress.get(`create-${domain.givenDomainName}`);
            ...
            try {
                ...
                yield route53.changeResourceRecordSet("UPSERT", domain);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (domain.domainInfo) {
                    ...
                    yield route53.changeResourceRecordSet("DELETE", domain);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            yield Promise.all(this.domains.map((domain) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const mappings = yield this.apiGatewayWrapper.getApiMappings(domain);
                    const filteredMappings = mappings.filter((mapping) => {
                        return mapping.ApiId === domain.apiId || (mapping.ApiMappingKey === domain.basePath && domain.allowPathMatching);
                    });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (const domain of this.domains) {
                ...
                if (domain.domainInfo) {
                    ...
                    globals_1.default.logInfo(`Unable to print ${globals_1.default.pluginName} Summary for ${domain.givenDomainName}`);
                }
            }
        });
    }
