...
class APIGatewayWrapper {
    ...
    createCustomDomain(domain) {
        return __awaiter(this, void 0, void 0, function* () {
            let createdDomain = {};
            const tags = Object.assign(Object.assign({}, globals_1.default.serverless.service.provider.stackTags), globals_1.default.serverless.service.provider.tags);
            ...
            if (domain.endpointType === globals_1.default.endpointTypes.edge || domain.securityPolicy === "TLS_1_0") {
                ...
                try {
                    ...
                    createdDomain = yield (0, utils_1.throttledCall)(this.apiGateway, "createDomainName", params);
                ...
                try {
                    ...
                    createdDomain = yield (0, utils_1.throttledCall)(this.apiGatewayV2, "createDomainName", params);
                    domain.domainInfo = new DomainInfo(createdDomain);
                }
                catch (err) {
                    globals_1.default.logError(err, domain.givenDomainName);
