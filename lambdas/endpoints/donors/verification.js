        ...
        if (res.length) {
            ...
            if (!existingDonor.verified) {
                ...
                if (hashCompare) {
                    ...
                    return Responses._200({ messages: { 'success': 'Your email address has successfully been verified.<br /><br /><a href="https://www.cause-foundation.org.uk/">Click here to go to the website.</a>' }});
                }
            } else {
                return Responses._200({ messages: { 'success': 'Your email address has successfully been verified.<br /><br /><a href="https://www.cause-foundation.org.uk/">Click here to go to the website.</a>' }});
            }
        }
        return Responses._400({ messages: { 'error': 'There was an error verifying your email address, please try the link again or <a href="https://www.cause-foundation.org.uk/contact-us-i3">Contact Us</a> if the problem persists.' } })
